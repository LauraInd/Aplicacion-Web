...
<div class="container">
    <div class="row py-4">
        ...
        <div class="col text-end">
          <a href="belongs/Recipe/view.jsp" class="btn btn-primary btn-lg me-2">Buscar Receta</a>
          <a href="belongs/Recipe/add.jsp" class="btn btn-success btn-lg">Agregar Receta</a>
        </div>
    </div>
</div>
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <div class="btn-group">
                            <a href="belongs/Recipe/recipes/view.jsp?id=<%= recipe.getId() %>" class="btn btn-outline-primary">Ver</a>
                            <a href="belongs/Recipe/recipes/edit.jsp?id=<%= recipe.getId() %>" class="btn btn-outline-warning">Editar</a>
                            <a href="belongs/Recipe/remove.jsp?id=<%= recipe.getId() %>" class="btn btn-outline-danger">Eliminar</a>
                        </div>
                    </div>
                </div>
            </div>
